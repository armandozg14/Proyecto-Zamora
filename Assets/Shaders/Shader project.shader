Shader "Custom/Shader project"
{
    Properties
    {
        ...
        //Wrap
        _FallOff("Falloff", Range(0.0, 0.5)) = 0.0
    ...
    SubShader
    {
        Tags
        {
         ...
         CGPROGRAM 
            #pragma surface surf Shaderproject
            ...
            half4 LightingShaderproject(SurfaceOutput s, half3 lightDir, half3 viewDir, half atten)
            {
